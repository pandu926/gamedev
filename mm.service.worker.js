...
/** @type {string} */
const CACHE_VERSION = '1732363606|4960676374';
/** @type {string} */
const CACHE_PREFIX = 'New Game Project-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'mm.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["mm.html","mm.js","mm.offline.html","mm.icon.png","mm.apple-touch-icon.png","mm.worker.js","mm.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["mm.wasm","mm.pck"];
